...
- 设计坐标类，可以同时设置int类型和String类型的坐标。

**源码：** GenericTypeTest.java
```java
...
public void pointDemo() {
    ...
    point.setStringX("东经125°42' - 130°10'");
    point.setStringY("北纬44°04' - 46°40'");
...
**源码：** GenericTypeTest.java 中添加
```java
static class PointDemoPro<T> {
    private T x;
    private T y;
    public PointPro(){} 
...
```java
@Test
public void pointDemoPro() {
    PointDemoPro<Integer> pointA = new PointDemoPro<>();
    pointA.setX(10);
    pointA.setY(20);
    System.out.println(pointA.getX() + " : " + pointA.getY());
    PointDemoPro<String> pointB = new PointDemoPro<>();
    pointB.setX("东经125°42' - 130°10'");
    pointB.setY("北纬44°04' - 46°40'");
